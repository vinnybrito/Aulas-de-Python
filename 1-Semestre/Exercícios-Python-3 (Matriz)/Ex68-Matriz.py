# 68- Entrar via teclado com doze valores e armazená-los em uma matriz de ordem 3x4. 
# Após a digitação dos valores solicitar uma constante multiplicativa, que deverá 
# multiplicar cada valor matriz e armazenar o resultado na própria matriz, nas 
